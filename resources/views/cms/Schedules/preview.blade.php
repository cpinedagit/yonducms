        ...
        <div class="row">
            <div id="mainBannerDivParent">
                <div class="col-xs-9 col-sm-9 col-md-9 banner mainBanner">
                    ...
                    <div class="banner-slider">
                        <div class ='divImage'>
				    <img src="../public/beam/images/lg-thumbnails/big-love/img-1.jpg" alt="">
                            <div class="mask"></div>
                        </div>
                    </div>
                </div>
            ...
            <aside class="col-xs-3 col-sm-3 col-md-3">
                ...
                <div class="schedule__list">
                    ...
                    <div>
				<a class='scheduleId' data-id='{{$schedule->id}}' data-image='{{ $schedule->image }}' href='#'>
	  ...
	  $('.scheduleId').on('click', function () {
		...
		$.ajax({
		    ...
		    success: (function (data) {
			  ...
			  $.getScript("../public/beam/js/slick.js", function () {
				slicky();
			  });
			  $('.modal-body').empty();
