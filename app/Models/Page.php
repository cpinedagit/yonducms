...
class Page extends Model {
    ...
    public static function updatePage($id) {
	  ...
	  if(Input::get('checkboxPageStatus')){
		$page->status = Input::get('checkboxPageStatus');
	  }else{
    ...
    public static function getPageStatus($id) {
	  return DB::table('pages')->where('id', '=', $id)->pluck('status');
    }
}
