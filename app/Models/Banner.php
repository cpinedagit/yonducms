...
class Banner extends Model {
    ...
    public static function updateBanner($id) {
	  ...
	  $numberOfImages = Input::get('numberOfImages');
	  ...
	  $banner->numberOfImages = Input::get('numberOfImages');
	  if (isset($width)) {
		$banner->standard_images_width = $width;
	  }
	  $banner->save();
    }
    ...
    public static function getStandardBannerWidth($id) {
	  return DB::table('banners')->where('id', '=', $id)->pluck('standard_images_width');
    }
    
    public static function getNumberOfImages($id) {
	  return DB::table('banners')->where('id', '=', $id)->pluck('numberOfImages');
    }
